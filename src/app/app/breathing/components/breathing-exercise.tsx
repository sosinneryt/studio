  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full">
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <div
          className={cn(
            'absolute rounded-full bg-primary/20 ease-in-out',
            isBreathingIn || isHolding ? 'scale-100' : 'scale-50'
          )}
          style={{ width: '100%', height: '100%', transition: `transform ${currentPhase.duration}ms` }}
        />
        <div
          className={cn(
            'absolute rounded-full bg-primary/40 ease-in-out',
        ...
        <div
          className={cn(
            'relative w-48 h-48 rounded-full bg-primary flex items-center justify-center ease-in-out',
            isBreathingIn ? 'scale-125' : 'scale-100'
          )}
          style={{ transition: `transform ${currentPhase.duration}ms` }}
        >
